...
###Example 2.8
```{python ex2.8, echo=TRUE, warning=FALSE, results='hide', fig.keep='all'}
...
```{python ex2.9, echo=TRUE, warning=FALSE, results='hide', fig.keep='all'}
